...
class InstallationProxyService(LockdownService):
    ...
    async def get_apps(
        ...
        """Get applications according to the given criteria."""
        options = {}
        ...
        if app_types is None:
            ...
            if application_type != "Any":
                app_types = [application_type]
        elif len(app_types) == 1:
            options["ApplicationType"] = app_types[0]
        else:
            options["ApplicationType"] = "Any"

        if show_placeholders:
            # Keep support for placeholder apps.
            # See: https://github.com/doronz88/pymobiledevice3/issues/1602
